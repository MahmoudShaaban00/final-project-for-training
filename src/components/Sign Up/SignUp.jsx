      ...
      <div className=' grid sm:grid-cols-2 my-10 grid-cols-1'>
        ...
        <div className='xl:mt-20 mt-5'>
          ...
          <form onSubmit={formik.handleSubmit} className='xl:px-48 mt-10 sm:pr-10 md:pr-32 px-5'>
            ...
            <button type="submit" className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full px-20  sm:w-auto  py-2.5 text-center dark:bg-blue-600 dark:hover:bg-red-700 dark:focus:ring-red-800 lg:ml-2">Create Account</button>
          </form>
          <button onClick={()=>  loginWithRedirect() } className="bg-blue-500 sm:w-auto w-[90%] text-white font-semibold py-2 px-16 sm:px-12 rounded-lg ml-5  xl:ml-48 mt-2 shadow hover:bg-blue-600 transition duration-300 flex"><FcGoogle  className='text-2xl mr-4 '/>Sign Up With Google</button>
